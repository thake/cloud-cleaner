...
suspend fun CloudFormationClient.createStack(
    ...
    val imports = imports.mapIndexed { index, it ->
        """
            "Import$index": {
    ...
    val outputs = outputs.mapIndexed { index, it ->
        """
            "Output$index": {
...
suspend fun fillAccountWithResources(credentials: CredentialsProvider) {
    val cloudFormationClient = CloudFormationClient { region = "us-east-1"; credentialsProvider = credentials }
    val cloudWatchLogsClient = CloudWatchLogsClient { region = "us-east-1"; credentialsProvider = credentials }
    val ec2Client = Ec2Client { region = "us-east-1"; credentialsProvider = credentials }
    val iamClient = IamClient { region = "us-east-1"; credentialsProvider = credentials }
    val ecrClient = EcrClient { region = "us-east-1"; credentialsProvider = credentials }
    val route53Client = Route53Client { region = "us-east-1"; credentialsProvider = credentials }
    val s3Client = S3Client { region = "us-east-1"; credentialsProvider = credentials }
    val secretsManagerClient = SecretsManagerClient { region = "us-east-1"; credentialsProvider = credentials }
    val ssmClient = SsmClient { region = "us-east-1"; credentialsProvider = credentials }
